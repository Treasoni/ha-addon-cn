...
Brave 是一款面向 PC、Mac 和移动端的快速、隐私且安全的网页浏览器。本 add-on 基于 linuxserver 的 docker-brave 镜像，将 Brave 浏览器运行在 Home Assistant 中，可通过 Ingress 在侧边栏直接使用。
...
启动后可在 Home Assistant 侧边栏看到 Brave 图标，点击进入。Web 界面（HTTPS）容器端口 3001/tcp 默认映射到宿主端口 3001；Chrome 调试端口 9221/tcp 默认禁用。
...
---
- 英文原版：[Home assistant add-on: Brave](https://github.com/alexbelgium/hassio-addons/blob/master/brave/README.md)
- 来源仓库：alexbelgium
